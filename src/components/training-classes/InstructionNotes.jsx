...
const InstructionNotes = () => {
    ...
    return (
        <div>
            <div className='instruction__container' style={{ padding: '20px',marginLeft: '30px' }}>
                <div>
                    <p className='body__1 mb-20' style={{ color: '#181A53' }}>Instructor’s notes</p>
                    <div className='card card1' style={{ display: 'block', padding: 0, border: '1px solid #E2E2E2', padding: '15px'}}>
                        <div className='card-body'>
                            <div className='card-header' style={{borderBottom: '1px solid #888888'}}>
                                <div>
                                    <button
                ...
                <div>
                    <p className='body__1 mb-20' style={{ color: '#181A53' }}>Recommended Learning Path</p>
